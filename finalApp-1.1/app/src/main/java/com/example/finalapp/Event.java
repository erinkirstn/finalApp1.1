...
public class Event implements Parcelable{
    ...
    public Event(String title, String date, int month, int day, int year) {
        this.title = title;
        this.date = date;
        this.month = month;
        this.day = day;
     ...
     * @param key
     */
    public Event(String title, String date, int month, int day, int year, String key) {
        this.title = title;
        this.date = date;
        this.month = month;
        this.day = day;
    ...
    public boolean equals(Event other) {
        return this.date.equals(other.date) && this.title.equals(other.title);
    }
